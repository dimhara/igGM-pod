...
# Ensure uv uses the pre-installed python environment
ENV UV_SYSTEM_PYTHON=1 

# Install system dependencies for PyRosetta and OpenMM
...
# 1. Clone IgGM source code
RUN git clone https://github.com/TencentAI4S/IgGM.git .

# 2. Use uv to install dependencies
# We combine them to save layer space. 
# --find-links (-f) is used for the specific PyG CUDA wheels.
...
# Keep container alive for RunPod interactive usage
